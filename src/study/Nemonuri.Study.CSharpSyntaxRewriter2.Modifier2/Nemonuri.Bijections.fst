(*
original source
- https://github.com/FStarLang/FStar/blob/master/ulib/FStar.Bijection.fsti
- https://github.com/FStarLang/FStar/blob/master/ulib/FStar.Bijection.fst
*)

module Nemonuri.Bijections
