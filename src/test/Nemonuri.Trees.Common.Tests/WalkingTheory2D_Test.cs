...
public class WalkingTheory2D_Test
{
    ...
    )
    {
        ...
        AdHocRoseNodeAggregating2DPremise<int, bool> aggregatingPremise =
            RoseNodeAggregating2DPremiseTestTheory.CreateForallPremiseUsingOptionalAggregator
            (
                roseNodePremise,
                static i => i >= 0
            );
        ...
        // Act
        bool success = WalkingTheory2D.TryWalkAsRoot(aggregatingPremise, roseNodePremise, roseNode, out var walkedValue);
