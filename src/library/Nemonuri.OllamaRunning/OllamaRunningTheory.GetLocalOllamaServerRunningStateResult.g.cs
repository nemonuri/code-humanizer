...
public static partial class OllamaRunningTheory
{
        ...
        IValueOrFailure<LocalOllamaServerRunningState, GetLocalOllamaServerRunningStateResult.FailInfo>
    {
        ...
        public GetLocalOllamaServerRunningStateResult(ValueOrFailure<LocalOllamaServerRunningState, FailInfo> internalSource)
        {
            ...
            System.Diagnostics.Debug.WriteLine("GetLocalOllamaServerRunningStateResult constructed. " + ToString());
        }
        ...
        public static GetLocalOllamaServerRunningStateResult CreateAsCanceled
        (string message = "") =>
            new(FailureTheory.Create(FailInfo.Canceled, message));

        public static GetLocalOllamaServerRunningStateResult CreateAsProcessStartFailed
        ...
        public static GetLocalOllamaServerRunningStateResult CreateAsSolveLocalOllamaServerRunningStateFailed
        (string message = "") =>
            new(FailureTheory.Create(FailInfo.SolveLocalOllamaServerRunningStateFailed, message));
        ...
        public override string ToString() =>
            "GetLocalOllamaServerRunningStateResult {" +
            (
                IsValue ? 
